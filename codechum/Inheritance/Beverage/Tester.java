        ...
        if (code == 1) {
            ...
            try {
                ...
                if (beverage instanceof Water) {
                    ...
                    expected = "Beer" + " (" + volume + "mL) " + isChilledStr + " (" + String.format("%.1f", alcoholicContent * 100) + "% alcoholic content)";
                    if (expected.equals(beverage.toString())) {
                        System.out.println("SUCCESS");
                        return;
                    }
            ...
            try {
                if (beverage instanceof Water) {
                    ...
                    if(alcoholicContent != null) {
                        ...
                        if (!(Double.parseDouble(value.toString()) == Double.parseDouble(getAlcoholicContent.invoke(beverage).toString()))){
                            System.out.println("FAILED");
                            return;
                        }
                    } else {
